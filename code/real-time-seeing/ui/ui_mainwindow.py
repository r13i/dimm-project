...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("../../.designer/index.jpeg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.button_noise = QtWidgets.QPushButton(self.widget)
        self.button_noise.setObjectName("button_noise")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.SpanningRole, self.button_noise)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.lineedit_path)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.lineedit_filename)
        ...
        self.formLayout.setWidget(8, QtWidgets.QFormLayout.SpanningRole, self.line_5)
        ...
        self.formLayout.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.spinbox_lambda)
        ...
        self.formLayout.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.spinbox_b)
        ...
        self.formLayout.setWidget(14, QtWidgets.QFormLayout.FieldRole, self.spinbox_d)
        ...
        self.spinbox_focal.setProperty("value", 500.0)
        self.spinbox_focal.setObjectName("spinbox_focal")
        self.formLayout.setWidget(15, QtWidgets.QFormLayout.FieldRole, self.spinbox_focal)
        ...
        self.spinbox_pwidth.setProperty("value", 10.0)
        self.spinbox_pwidth.setObjectName("spinbox_pwidth")
        self.formLayout.setWidget(16, QtWidgets.QFormLayout.FieldRole, self.spinbox_pwidth)
        ...
        self.spinbox_pheight.setProperty("value", 10.0)
        self.spinbox_pheight.setObjectName("spinbox_pheight")
        self.formLayout.setWidget(17, QtWidgets.QFormLayout.FieldRole, self.spinbox_pheight)
        ...
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.slider_threshold)
        self.checkbox_thresh = QtWidgets.QCheckBox(self.widget)
        self.checkbox_thresh.setLayoutDirection(QtCore.Qt.RightToLeft)
        self.checkbox_thresh.setObjectName("checkbox_thresh")
        self.formLayout.setWidget(11, QtWidgets.QFormLayout.LabelRole, self.checkbox_thresh)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_noise.setToolTip(_translate("MainWindow", "<html><head/><body><p>Press this button to select the Regions of Interest (where the two star projections are located)</p></body></html>"))
        self.button_noise.setWhatsThis(_translate("MainWindow", "<html><head/><body><p>Press this button to select the Regions of Interest (where the two star projections are located)</p></body></html>"))
        self.button_noise.setText(_translate("MainWindow", "Select Noise Area"))
        ...
        self.checkbox_thresh.setText(_translate("MainWindow", "Threshold (auto)"))
